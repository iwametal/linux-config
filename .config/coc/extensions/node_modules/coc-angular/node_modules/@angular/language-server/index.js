...
define(['fs', 'path', 'typescript/lib/tsserverlibrary', 'vscode-languageserver', 'vscode-uri'], function (fs, path, tsserverlibrary, vscodeLanguageserver, vscodeUri) { 'use strict';
	...
	tsserverlibrary = tsserverlibrary && Object.prototype.hasOwnProperty.call(tsserverlibrary, 'default') ? tsserverlibrary['default'] : tsserverlibrary;
	...
	vscodeUri = vscodeUri && Object.prototype.hasOwnProperty.call(vscodeUri, 'default') ? vscodeUri['default'] : vscodeUri;
  ...
  `;
	...
	exports.projectLoadingNotification = {
	    start: new vscodeLanguageserver.NotificationType0('angular-language-service/projectLoadingStart'),
	    finish: new vscodeLanguageserver.NotificationType0('angular-language-service/projectLoadingFinish')
	};
