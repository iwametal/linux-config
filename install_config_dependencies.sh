...
sudo pacman -S alacritty alsa alsa-lib alsa-plugins at bashtop bc bind bluez bluez-utils ccls cron cups dash dmenu docker docker-compose docker-machine dotnet-runtime dotnet-sdk dragon emacs exa feh flameshot fzf gdb giflib gnutls gst-plugins-base-libs gtk3 iotop iperf jq lib32-alsa-lib lib32-alsa-plugins lib32-giflib lib32-gnutls lib32-gst-plugins-base-libs lib32-gtk3 lib32-libjpeg-turbo lib32-libldap lib32-libgcrypt lib32-libgpg-error lib32-libpng lib32-libpulse lib32-libva lib32-libxcomposite lib32-libxinerama lib32-libxslt lib32-mpg123 lib32-ncurses lib32-nvidia-utils lib32-openal lib32-opencl-icd-loader lib32-sqlite lib32-v4l-utils lib32-vulkan-icd-loader libgcrypt libjpeg-turbo libldap libgpg-error libpulse libva libxcomposite libxinerama libxslt maim mpg123 mtr ncmpcpp ncurses neofetch neovim networkmanager nftables noto-fonts-cjk nvidia nvidia-utils openal opencl-icd-loader openvpn pacman-contrib procs pulseaudio python-lxml ripgrep rustup sshpass smem spotifyd sqlite strace stress sysstat tldr tokei traceroute ttf-joypixels v4l-utils vifm vim vivaldi vivaldi-ffmpeg-codecs vulkan-icd-loader wine-staging wine-gecko wine-mono wireless_tools wpa_supplicant xclip xf86-video-vesa xorg-xcalc xorg-server xorg-xinit xorg-xprop xorg-xset --noconfirm
...
paru -S dragon-drag-and-drop libxft-bgra-git mrtg nvim-packer-git protonvpn soapui spotify spotify-tui python-ueberzug-git vim-plug wal --noconfirm
...
sudo pacman -S alsa-utils audacious bat discord dpkg dunst figlet htop inetutils intellij-idea-community-edition jp2a lazygit links lolcat maven mpv mypaint ncdu net-tools obs-studio pamixer pavucontrol playerctl ranger screen sxiv tigervnc tree ttf-font-awesome tmux vimiv vlc x11vnc xinetd youtube-dl zathura zathura-cb zathura-djvu zathura-pdf-mupdf zathura-ps --noconfirm
